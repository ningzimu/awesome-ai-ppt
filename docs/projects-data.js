window.AWESOME_AI_PPT_PROJECTS = [
  ...
  },
  {
    ...
    "type": "Framework",
    "output": "PPTX/PDF/PNG",
    "description": "Markdown and Vue-based slide framework with browser and CLI export to PPTX, PDF, PNG, and Markdown.",
    "descriptionZh": "基于 Markdown 和 Vue 的网页幻灯片框架，支持通过浏览器或 CLI 导出 PPTX、PDF、PNG 和 Markdown。",
    "tags": [
      "HTML-first",
      "Markdown",
      "Vue",
