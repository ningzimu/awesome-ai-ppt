window.AWESOME_AI_PPT_PROJECTS = [
  ...
  },
  {
    ...
    "repo": "open-xml-templating/docxtemplater",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "Library",
    "output": "DOCX/PPTX",
    "description": "Template engine for generating DOCX and PPTX with placeholders, loops, and conditions; advanced PowerPoint modules are commercial.",
    "descriptionZh": "通过占位符、循环和条件生成 DOCX 与 PPTX 的模板引擎；高级 PowerPoint 模块为商业模块。",
    "tags": [
      "Library",
      "Template",
      "Automation",
  ...
  {
    "name": "zarazhangrui/beautiful-html-templates",
    ...
    "output": "HTML",
    "description": "Agent-oriented library of reusable HTML slide templates with an index and operating guide for selecting and adapting decks.",
    "descriptionZh": "面向 coding agent 的可复用 HTML 幻灯片模板库，提供模板索引以及选择和改编 deck 的操作指南。",
    "tags": [
      "HTML-first",
      "Template",
      "Agent"
  ...
  {
    "name": "stackblitz/bolt-slides",
    "url": "https://github.com/stackblitz/bolt-slides",
    "repo": "stackblitz/bolt-slides",
    "category": "HTML-First Presentation Workflows",
    "categoryZh": "HTML 风格 PPT 方案",
    "type": "Framework",
    "output": "HTML",
    "description": "React presentation framework with a bundled agent skill for producing interactive, responsive web decks.",
    "descriptionZh": "附带 agent skill 的 React 演示框架，用于生成交互式、响应式 Web deck。",
    "tags": [
      "HTML-first",
      "React",
      "Interactive"
  ...
  },
  {
    ...
    "type": "Skill",
    "output": "PPTX",
    "description": "Agent skill that turns papers, repositories, and documents into native editable PPTX with notes, charts, and automated review.",
    "descriptionZh": "将论文、代码仓库和文档生成原生可编辑 PPTX 的 agent skill，支持备注、图表和自动审核。",
    "tags": [
      "PPTX-native",
      "Template",
      "Automation",
  ...
  },
  {
    ...
    "repo": "HKUDS/Paper2Slides",
    "category": "Image-First Presentation Workflows",
    "categoryZh": "图片生成式 PPT 方案",
    "type": "App",
    "output": "Images/PDF",
    "description": "Document-to-slide pipeline that uses RAG, planning, and image generation to render slide images and PDF decks.",
    "descriptionZh": "通过 RAG、内容规划和图像生成把文档渲染为幻灯片图片与 PDF deck 的工作流。",
    "tags": [
      "Image-first",
      "Image-based",
      "Academic",
  ...
  {
    "name": "wyozi/react-pptx",
    "url": "https://github.com/wyozi/react-pptx",
    "repo": "wyozi/react-pptx",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "Library",
    "output": "PPTX",
    "description": "React wrapper for PptxGenJS that creates PowerPoint presentations from declarative JSX components in Node.js or the browser.",
    "descriptionZh": "PptxGenJS 的 React 封装，可在 Node.js 或浏览器中通过声明式 JSX 组件创建 PowerPoint。",
    "tags": [
      "Library",
      "React",
      "PPTX-native"
  ...
  {
    "name": "EveryInc/hands-on-deck",
    "url": "https://github.com/EveryInc/hands-on-deck",
    "repo": "EveryInc/hands-on-deck",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "CLI",
    "output": "PPTX",
    "description": "Agent-oriented CLI and skill for inspecting, patching, creating, rendering, linting, and verifying PowerPoint files.",
    "descriptionZh": "面向 agent 的 PowerPoint CLI 与 skill，支持检查、补丁编辑、创建、渲染、lint 和验证 PPTX。",
    "tags": [
      "CLI",
      "Automation",
      "PPTX-native",
  ...
  {
    "name": "xiao24bei/xiaobei-skill-image-to-vba",
    "url": "https://github.com/xiao24bei/xiaobei-skill-image-to-vba",
    "repo": "xiao24bei/xiaobei-skill-image-to-vba",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "Skill",
    "output": "VBA/PowerPoint",
    "description": "Agent skill for reconstructing academic figures and slide screenshots as editable Office shapes and VBA code.",
    "descriptionZh": "将学术图像和幻灯片截图重建为可编辑 Office shapes 与 VBA 代码的 agent skill。",
    "tags": [
      "Conversion",
      "Image-based",
      "VBA",
  ...
  {
    "name": "Akxan/ppt-agent-skill",
    "url": "https://github.com/Akxan/ppt-agent-skill",
    "repo": "Akxan/ppt-agent-skill",
    "category": "HTML-First Presentation Workflows",
    "categoryZh": "HTML 风格 PPT 方案",
    "type": "Skill",
    "output": "HTML/SVG/PPTX",
    "description": "Claude Code skill that designs slides as HTML, converts them to SVG, and packages the result as editable PPTX.",
    "descriptionZh": "先以 HTML 设计幻灯片、再转换为 SVG 并打包为可编辑 PPTX 的 Claude Code skill。",
    "tags": [
      "HTML-first",
      "Conversion",
      "Template",
  ...
  {
    "name": "M1n-n9/academic-ppt-master",
    "url": "https://github.com/M1n-n9/academic-ppt-master",
    "repo": "M1n-n9/academic-ppt-master",
    "category": "HTML-First Presentation Workflows",
    "categoryZh": "HTML 风格 PPT 方案",
    "type": "Skill",
    "output": "SVG/PPTX",
    "description": "Academic presentation skill that turns papers and documents into SVG-designed slide pages and editable PPTX decks.",
    "descriptionZh": "将论文和文档制作成 SVG 页面并导出为可编辑 PPTX 的学术演示 skill。",
    "tags": [
      "HTML-first",
      "PPTX-native",
      "Academic",
  ...
  },
  {
    ...
    "repo": "PHPOffice/PHPPresentation",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "Library",
    "output": "PPTX/ODP",
    "description": "LGPL-3.0 PHP library for creating and writing PowerPoint and OpenDocument presentation files.",
    "descriptionZh": "用于创建和写入 PowerPoint 与 OpenDocument 演示文件的 LGPL-3.0 PHP 库。",
    "tags": [
      "Library",
      "PPTX-native",
      "Automation"
  ...
  },
  {
    ...
    "description": "Marp CLI for converting Markdown slide decks into HTML, PDF, images, and PowerPoint files.",
    "descriptionZh": "Marp 命令行工具，可将 Markdown 幻灯片转换为 HTML、PDF、图片和 PowerPoint 文件。",
    "tags": [
      "HTML-first",
      "Markdown",
      "Conversion"
  ...
  },
  {
    ...
    "repo": "icip-cas/PPTAgent",
    "category": "PPTX-Native Generation Workflows",
    "categoryZh": "PPTX 库生成式 PPT 方案",
    "type": "Agent",
    "output": "PPTX",
    "description": "Agentic framework for reflective PowerPoint generation with PPTX export, offline mode, WebUI, CLI, and MCP support.",
    "descriptionZh": "用于反思式 PowerPoint 生成的 agentic framework，支持 PPTX 导出、离线模式、WebUI、CLI 和 MCP。",
    "tags": [
      "PPTX-native",
      "Agent",
      "MCP",
  ...
  },
  {
    ...
    "type": "Skill",
    "output": "PPTX",
    "description": "Python-pptx skill for building editable PowerPoint decks by applying structured text edits to bundled templates; the templates are limited to personal, research, and non-commercial educational use.",
    "descriptionZh": "通过结构化文本编辑和内置模板生成可编辑 PowerPoint 的 python-pptx skill；其中模板仅限个人、研究和非商业教育用途。",
    "tags": [
      "PPTX-native",
      "Template",
      "Automation"
  ...
  {
    "name": "YOOTeam/OpenPPT",
    "url": "https://github.com/YOOTeam/OpenPPT",
    "repo": "YOOTeam/OpenPPT",
    "category": "PPTX-Native Generation Workflows",
    "categoryZh": "PPTX 库生成式 PPT 方案",
    "type": "App",
    "output": "PPTX/PDF",
    "description": "Open-source AI PPT editor covering generation, import, online editing, presentation playback, and Office-compatible PPTX export.",
    "descriptionZh": "开源 AI PPT 编辑器，覆盖生成、导入、在线编辑、演示播放和 Office 兼容 PPTX 导出。",
    "tags": [
      "PPTX-native",
      "App",
      "Editor",
  ...
  },
  {
    ...
    "repo": "OpenDCAI/Paper2Any",
    "category": "PPTX-Native Generation Workflows",
    "categoryZh": "PPTX 库生成式 PPT 方案",
    "type": "App",
    "output": "PPTX/SVG/DrawIO",
    "description": "Research-paper multimodal workflow for editable figures, diagrams, posters, and slide decks, including Paper2PPT, PDF2PPT, and Image2PPT.",
    "descriptionZh": "面向论文的多模态工作流，可生成可编辑科研图、图解、海报和幻灯片，包含 Paper2PPT、PDF2PPT 和 Image2PPT。",
    "tags": [
      "PPTX-native",
      "Academic",
      "Conversion",
  ...
  },
  {
    ...
    "description": "Local-first Office CLI for AI agents to create, inspect, edit, render, and automate PowerPoint files without Microsoft Office.",
    "descriptionZh": "面向 AI agent 的本地优先 Office CLI，可在无需 Microsoft Office 的情况下创建、检查、编辑、渲染和自动化 PowerPoint。",
    "tags": [
      "CLI",
      "Automation",
      "PPTX-native",
  ...
  {
    "name": "laihenyi/NBLM2PPTX",
    "url": "https://github.com/laihenyi/NBLM2PPTX",
    "repo": "laihenyi/NBLM2PPTX",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "Converter",
    "output": "PPTX",
    "description": "Converts NotebookLM PDF slide exports into PPTX with slide backgrounds and editable text layers.",
    "descriptionZh": "将 NotebookLM 导出的 PDF 幻灯片转换为带背景图和可编辑文字层的 PPTX。",
    "tags": [
      "Conversion",
      "PDF",
      "Image-based",
  ...
  {
    "name": "archlizheng/frontend-slides-editable",
    "url": "https://github.com/archlizheng/frontend-slides-editable",
    "repo": "archlizheng/frontend-slides-editable",
    "category": "HTML-First Presentation Workflows",
    "categoryZh": "HTML 风格 PPT 方案",
    "type": "Skill",
    "output": "HTML",
    "description": "Editable HTML presentation skill for Codex and Claude Code with drag-resize editing, slide reordering, local save/export, and PPTX-to-web conversion.",
    "descriptionZh": "面向 Codex 和 Claude Code 的可编辑 HTML 演示 skill，支持拖拽缩放、页面排序、本地保存/导出和 PPTX 转网页。",
    "tags": [
      "HTML-first",
      "Editor",
      "Conversion",
  ...
  },
  {
    ...
    "type": "Plugin",
    "output": "PPTX",
    "description": "Claude Code plugin for McKinsey-style PPTX generation with consulting slide templates and a template-selection subagent.",
    "descriptionZh": "用于生成咨询风 PPTX 的 Claude Code plugin，内置咨询幻灯片模板和模板选择 subagent。",
    "tags": [
      "PPTX-native",
      "Template",
      "Consulting",
  ...
  {
    "name": "zouchenzhen/thesis-defense-pptx-skill",
    "url": "https://github.com/zouchenzhen/thesis-defense-pptx-skill",
    "repo": "zouchenzhen/thesis-defense-pptx-skill",
    "category": "PPTX-Native Generation Workflows",
    "categoryZh": "PPTX 库生成式 PPT 方案",
    "type": "Skill",
    "output": "PPTX",
    "description": "Claude Code skill for generating editable thesis-defense PowerPoint decks from LaTeX or PDF papers and PPTX templates.",
    "descriptionZh": "从 LaTeX 或 PDF 论文和 PPTX 模板生成可编辑论文答辩 PowerPoint 的 Claude Code skill。",
    "tags": [
      "PPTX-native",
      "Academic",
      "Template",
  ...
  {
    "name": "snowmanzhuang/yixueAIganhuo-PPT",
    "url": "https://github.com/snowmanzhuang/yixueAIganhuo-PPT",
    "repo": "snowmanzhuang/yixueAIganhuo-PPT",
    "category": "Image-First Presentation Workflows",
    "categoryZh": "图片生成式 PPT 方案",
    "type": "Skill",
    "output": "PPTX",
    "description": "Medical academic PPT workflow based on gpt-image-2 and PaddleOCR for generating slide decks from papers, PDFs, figures, screenshots, and prepared materials, then rebuilding editable PPTX files.",
    "descriptionZh": "基于 gpt-image-2 和 PaddleOCR 的医学学术 PPT 工作流，可从论文、PDF、图表、截图和整理材料生成幻灯片，并重建为可编辑 PPTX。",
    "tags": [
      "Image-first",
      "Image-based",
      "Academic",
  ...
  {
    "name": "soulmujoco/EditableImage2PPTSkill",
    "url": "https://github.com/soulmujoco/EditableImage2PPTSkill",
    "repo": "soulmujoco/EditableImage2PPTSkill",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "Skill",
    "output": "PPTX",
    "description": "Codex skill for reconstructing slide screenshots or exported slide images into editable PowerPoint decks with editable text, native shapes, extracted assets, and QA helpers.",
    "descriptionZh": "用于将幻灯片截图或导出的幻灯片图片重建为可编辑 PowerPoint 的 Codex skill，支持可编辑文本、原生形状、素材提取和 QA 辅助。",
    "tags": [
      "Conversion",
      "Image-based",
      "PPTX-native",
  ...
  {
    "name": "ShapeCrawler/ShapeCrawler",
    "url": "https://github.com/ShapeCrawler/ShapeCrawler",
    "repo": "ShapeCrawler/ShapeCrawler",
    "category": "PPTX Libraries and Automation Infrastructure",
    "categoryZh": "PPTX 库与自动化基础设施",
    "type": "Library",
    "output": "PPTX",
    "description": ".NET library for reading, creating, and modifying PowerPoint files through an API built on Open XML SDK.",
    "descriptionZh": "基于 Open XML SDK API 读取、创建和修改 PowerPoint 文件的 .NET 库。",
    "tags": [
      "Library",
      "PPTX-native",
      "Automation",
